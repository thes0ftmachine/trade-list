...
function shouldTransform(path) {
  ...
  if (elementPathsLength > 0 && elementPaths[elementPathsLength - 1].isRestElement()) {
    const {
      parentPath
    } = path;
